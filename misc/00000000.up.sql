...
CREATE TABLE IF NOT EXISTS "user"."group_profile" (
	"group_id" UUID NOT NULL,
	"description" VARCHAR(255) NOT NULL,
	"created_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL,
	"updated_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL,
	PRIMARY KEY ("group_id"),
	CONSTRAINT "fk_group_profile_group_id" FOREIGN KEY ("group_id") REFERENCES "user"."group" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
-- Permission
CREATE TYPE "user"."permission_resource_type" AS ENUM ('user', 'group', 'asset');
...
CREATE TABLE IF NOT EXISTS "user"."permission_scope" (
	"id" UUID NOT NULL,
	-- Permission scope are always related to an group
	"group_id" UUID NOT NULL,
	"name" VARCHAR(255) NOT NULL,
	"created_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL,
	"updated_at" TIMESTAMP WITHOUT TIME ZONE NOT NULL,
	PRIMARY KEY ("id"),
	CONSTRAINT "fk_permission_scope_group_id" FOREIGN KEY ("group_id") REFERENCES "user"."group" ("id") ON DELETE CASCADE ON UPDATE CASCADE
);
