...
var github_com_elojah_trax_pkg_twitch_follow_pb = require('../../../../../../github.com/elojah/trax/pkg/twitch/follow_pb.js');
  ...
  proto.dto.ListFollowResp.toObject = function (includeInstance, msg) {
    var f, obj = {
      followsList: jspb.Message.toObjectList(msg.getFollowsList(),
        github_com_elojah_trax_pkg_twitch_follow_pb.Follow.toObject, includeInstance),
...
proto.dto.ListFollowResp.deserializeBinaryFromReader = function (msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
      case 1:
        var value = new github_com_elojah_trax_pkg_twitch_follow_pb.Follow;
        reader.readMessage(value, github_com_elojah_trax_pkg_twitch_follow_pb.Follow.deserializeBinaryFromReader);
...
proto.dto.ListFollowResp.serializeBinaryToWriter = function (message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      github_com_elojah_trax_pkg_twitch_follow_pb.Follow.serializeBinaryToWriter
    );
  }
  f = message.getTotal();
  if (f !== 0) {
...
proto.dto.ListFollowResp.prototype.getFollowsList = function () {
  return /** @type{!Array<!proto.twitch.Follow>} */ (
    jspb.Message.getRepeatedWrapperField(this, github_com_elojah_trax_pkg_twitch_follow_pb.Follow, 1));
};
