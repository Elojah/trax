...
// @generated from protobuf file "github.com/elojah/trax/pkg/paginate/paginate.proto" (package "paginate", syntax proto3)
// tslint:disable
...
export interface Paginate {
    /**
     * @generated from protobuf field: int64 Start = 1 [json_name = "Start"];
     */
    start: bigint;
    /**
     * @generated from protobuf field: int64 End = 2 [json_name = "End"];
     */
    end: bigint;
    /**
     * @generated from protobuf field: string Sort = 3 [json_name = "Sort"];
     */
    sort: string;
    /**
     * @generated from protobuf field: bool Order = 4 [json_name = "Order"];
     */
    order: boolean;
}
...
class Paginate$Type extends MessageType<Paginate> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: Paginate): Paginate {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* int64 Start = 1 [json_name = "Start"];*/ 1:
                    message.start = reader.int64().toBigInt();
                    break;
                case /* int64 End = 2 [json_name = "End"];*/ 2:
                    message.end = reader.int64().toBigInt();
                    break;
                case /* string Sort = 3 [json_name = "Sort"];*/ 3:
                    message.sort = reader.string();
                    break;
                case /* bool Order = 4 [json_name = "Order"];*/ 4:
