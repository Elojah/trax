		...
		<div class="flex flex-wrap">
			<div
				...
				<div class="flex flex-col gap-2">
					<div class="text-surface-900 dark:text-surface-0 text-2xl font-semibold leading-tight">Join Tr@x
					</div>
					<div class="text-surface-900/60 dark:text-surface-0/60 leading-normal">Start tracking your solar
						production today.</div>
				</div>
				<div class="flex flex-col gap-6">
					<div class="flex gap-4">
						<div
							class="h-9 w-9 bg-surface-900 dark:bg-surface-50 rounded-lg flex items-center justify-center">
							<i class="pi pi-user-plus !text-base !leading-none text-white dark:text-surface-900" />
						</div>
						<div class="flex flex-col gap-2 flex-1">
							<div class="text-surface-900 dark:text-surface-0 font-medium">Easy Setup</div>
							<div class="text-surface-900/60 dark:text-surface-0/60 leading-normal">Get started in
					...
					<div class="flex gap-4">
						<div
							class="h-9 w-9 bg-surface-900 dark:bg-surface-50 rounded-lg flex items-center justify-center">
							<i class="pi pi-chart-line !text-base !leading-none text-white dark:text-surface-900" />
						</div>
						<div class="flex flex-col gap-2 flex-1">
							<div class="text-surface-900 dark:text-surface-0 font-medium">Real-time Monitoring
							</div>
							<div class="text-surface-900/60 dark:text-surface-0/60 leading-normal">Track your solar
								production and energy savings in real-time.</div>
						</div>
					</div>
					<div class="flex gap-4">
						<div
							class="h-9 w-9 bg-surface-900 dark:bg-surface-50 rounded-lg flex items-center justify-center">
							<i class="pi pi-users !text-base !leading-none text-white dark:text-surface-900" />
						</div>
						<div class="flex flex-col gap-2 flex-1">
							<div class="text-surface-900 dark:text-surface-0 font-medium">Community Insights</div>
							<div class="text-surface-900/60 dark:text-surface-0/60 leading-normal">Connect with other
								solar users and share best practices.</div>
						</div>
					</div>
				</div>
			</div>
