	...
	<v-container fluid>
		<v-toolbar class="bar-bg rounded-t-xl px-6" color="transparent" floating>
			...
			<v-dialog v-model="dialog" max-width="500px">
				<template v-slot:activator="{ props }">
					<v-btn class="rounded-xl" variant="outlined" color="primary" prepend-icon="mdi-plus-box"
						v-bind="props">
						New entity
		...
		<v-row>
			<v-col class="mx-auto" cols="6">
				<v-data-table-virtual class="rounded-b-xl" :headers="headers" hide-default-header :items="entities"
