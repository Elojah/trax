...
type CreateRoleReq struct {
	EntityID    pkg_ulid.ID       `protobuf:"bytes,1,opt,name=EntityID,proto3,customtype=pkg/ulid.ID" json:"EntityID"`
...
type ListRoleReq struct {
	...
	IDs       []pkg_ulid.ID      `protobuf:"bytes,5,rep,name=IDs,proto3,customtype=pkg/ulid.ID" json:"IDs"`
	EntityIDs []pkg_ulid.ID      `protobuf:"bytes,6,rep,name=EntityIDs,proto3,customtype=pkg/ulid.ID" json:"EntityIDs"`
}
...
var fileDescriptor_6c5520f4fb1c7a46 = []byte{
	...
	,
}
...
func NewPopulatedListRoleReq(r randyRole, easy bool) *ListRoleReq {
	...
	v10 := r.Intn(10)
	this.IDs = make([]pkg_ulid.ID, v10)
	for i := 0; i < v10; i++ {
		v11 := pkg_ulid.NewPopulatedID(r)
		this.IDs[i] = *v11
	}
	v12 := r.Intn(10)
	this.EntityIDs = make([]pkg_ulid.ID, v12)
	for i := 0; i < v12; i++ {
		v13 := pkg_ulid.NewPopulatedID(r)
...
func NewPopulatedCreateRoleUserReq(r randyRole, easy bool) *CreateRoleUserReq {
	...
	v19 := pkg_ulid.NewPopulatedID(r)
	this.RoleID = *v19
	v20 := pkg_ulid.NewPopulatedID(r)
	this.UserID = *v20
	if !easy && r.Intn(10) != 0 {
	}
	return this
...
func NewPopulatedDeleteRoleUserReq(r randyRole, easy bool) *DeleteRoleUserReq {
	...
	v21 := pkg_ulid.NewPopulatedID(r)
	this.RoleID = *v21
	v22 := pkg_ulid.NewPopulatedID(r)
	this.UserID = *v22
	if !easy && r.Intn(10) != 0 {
	}
	return this
