...
// @generated from protobuf file "internal/user/role.proto" (package "user", syntax proto3)
// tslint:disable
...
export interface Role {
    ...
    createdAt: string;
    /**
     * @generated from protobuf field: int64 UpdatedAt = 5
     */
    updatedAt: string;
}
/**
...
export interface Permission {
    ...
    roleID: Uint8Array;
    /**
     * @generated from protobuf field: user.Resource Resource = 2
     */
    resource: Resource;
    /**
     * @generated from protobuf field: user.Command Command = 3
     */
    command: Command;
    /**
     * @generated from protobuf field: int64 CreatedAt = 4
...
export enum Command {
    ...
    C_read = 0,
    /**
     * @generated from protobuf enum value: C_edit = 1;
     */
    C_edit = 1,
    /**
     * @generated from protobuf enum value: C_write = 2;
     */
    C_write = 2
}
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bytes RoleID */ 1:
                    ...
                    break;
                case /* user.Resource Resource */ 2:
                    message.resource = reader.int32();
                    break;
                case /* user.Command Command */ 3:
...
class RoleUser$Type extends MessageType<RoleUser> {
    constructor() {
        super("user.RoleUser", [
            ...
            { no: 3, name: "CreatedAt", kind: "scalar", jsonName: "CreatedAt", T: 3 /*ScalarType.INT64*/ },
            { no: 4, name: "UpdatedAt", kind: "scalar", jsonName: "UpdatedAt", T: 3 /*ScalarType.INT64*/ }
        ]);
    }
