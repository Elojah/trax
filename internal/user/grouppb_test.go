...
func BenchmarkGroupProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*Group, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedGroup(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkGroupProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		dAtA, err := github_com_gogo_protobuf_proto.Marshal(NewPopulatedGroup(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = dAtA
